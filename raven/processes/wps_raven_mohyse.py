...
params_defaults = MOHYSE.RVP.params(par_x01=1.0000,
                                    par_x02=0.0468,
                                    par_x03=4.2952,
                                    par_x04=2.6580,
                                    par_x05=0.4038,
...
hrus_defaults = MOHYSE.RVH.hrus(par_x09=0.9039, par_x10=5.6167)
...
class RavenMOHYSEProcess(RavenProcess):
    ...
    version = ''
    model_cls = MOHYSE
    tuple_inputs = {'params': MOHYSE.RVP.params, 'hrus': MOHYSE.RVH.hrus}

    inputs = [wio.ts, params, hrus, wio.start_date, wio.end_date, wio.duration, wio.run_name,
