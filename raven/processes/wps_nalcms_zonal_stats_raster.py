...
from raven.utils import archive_sniffer, crs_sniffer, generic_vector_reproject, raster_datatype_sniffer, single_file_check, zonalstats_raster_file
...
class NALCMSZonalStatisticsProcess(Process):
    ...
    def __init__(self):
        ...
        outputs = [
            ...
            ComplexOutput("raster", "DEM grid subset by the requested shape.",
                          abstract="Raster grid of land-use either standard or simplified UNFAO categories.",
