...
def MLR_parameters_regionalization(ncfilename,start_date, end_date, latitude, longitude, elevation, area,
    ...
    if hydrological_model == "GR4JCN":
        ...
        Qs=runLocalHMETS(MLR_param,ncfilename,start_date, end_date, latitude, area )
        Qsim[0:Qs.shape[0],1]=Qs
            
    elif hydrological_model == "MOHYSE":
        
        Qs=runLocalMOHYSE(MLR_param,ncfilename,start_date, end_date, latitude, area )
        Qsim[0:Qs.shape[0],1]=Qs
...
def distance_only_regionalization(ncfilename,start_date, end_date, latitude, longitude, elevation, area,
    ...
    for j in range(0, number_donors):
        ...
        if hydrological_model == "GR4JCN":
            ...
            Qs=runLocalHMETS(params,ncfilename,start_date, end_date, latitude, area )
            Qsim[0:Qs.shape[0],j]=Qs    
            
        elif hydrological_model == "MOHYSE":

            Qs=runLocalMOHYSE(params,ncfilename,start_date, end_date, latitude, area )
            Qsim[0:Qs.shape[0],j]=Qs
...
#### LOCAL MODEL DEFS
def runLocalHMETS(params,ts,start_date, end_date, latitude, area ):
    ...
    hmets([ts,], overwrite=True, rvp={'params':params}, rvi={'start_date':start_date, 'end_date':end_date}, rvh={'area':area, 'latitude':latitude})
...
def runLocalGR4JCN(params,ts,start_date, end_date, latitude, area ):
    ...
    gr4j([ts,], overwrite=True, rvp={'params':params}, rvi={'start_date':start_date, 'end_date':end_date}, rvh={'area':area, 'latitude':latitude})
...
def runLocalMOHYSE(params,ts,start_date, end_date, latitude, area ):
    ...
    mohyse([ts,], overwrite=True, rvp={'params':parSet}, rvi={'start_date':start_date, 'end_date':end_date}, rvh={'area':area, 'hrus':hrus, 'latitude':latitude})
