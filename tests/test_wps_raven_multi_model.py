...
from raven.processes import RavenMultiModelProcess, GraphEnsUncertaintyProcess
...
def test_graph_ensemble_uncertainty(request):
    ...
    resp = client.get(
        service='WPS', request='Execute', version='1.0.0', identifier='graph-ensemble-uncertainty',
