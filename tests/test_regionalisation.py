...
class TestRegionalisation:
    ...
    def testRegionalisationHMETS(self):
        ...
        for donors, method in zip([1, 5], ['PS_IDW_RA', 'PS_IDW']):
            inp['number_donors'] = donors
            inp['regionalisationMethod'] = method
            ...
            with Dataset(tmp_file) as ds:
                assert(ds.variables['Qsim'].shape[1] == inp['number_donors'])
